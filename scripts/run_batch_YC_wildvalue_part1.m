...
subject_list = {'sub-YC106', 'sub-YC107', 'sub-YC108', 'sub-YC109', 'sub-YC110', 'sub-YC113', 'sub-YC115', 'sub-YC116', 'sub-YC117', 'sub-YC118', 'sub-YC119', 'sub-YC120', 'sub-YC121', 'sub-YC122', 'sub-YC123', 'sub-YC124', 'sub-YC126', 'sub-YC128', 'sub-YC130', 'sub-YC131', 'sub-YC133', 'sub-YC134'};
...
for s = 1:numel(subject_list)
    ...
    fprintf('\n=== [%d/%d] Part 1: Coregister + Segment for %s ===\n\n', s, numel(subject_list), subject_id);
    ...
    if ~isfile(mri_raw) || ~isfile(pet_raw)
        fprintf('SKIPPING %s: input file missing.\n', subject_id);
        continue;
    end
    ...
    try
        ...
        fprintf('%s: Part 1 FAILED - %s\n', subject_id, ME.message);
    end
end

fprintf('\nBatch Part 1 complete.\n');
