...
matlabbatch{2}.spm.spatial.preproc.channel.vols = {'/home/jovyan/Desktop/workspace/undergraduate_project/rawdata/sub-AD01/anat/sub-AD01_T1w.nii,1'};
matlabbatch{2}.spm.spatial.preproc.channel.biasreg = 0.001;
matlabbatch{2}.spm.spatial.preproc.channel.biasfwhm = 60;
matlabbatch{2}.spm.spatial.preproc.channel.write = [1 1];
matlabbatch{2}.spm.spatial.preproc.tissue(1).tpm = {'/opt/spm12/spm12_mcr/spm12/spm12/tpm/TPM.nii,1'};
...
matlabbatch{2}.spm.spatial.preproc.tissue(2).tpm = {'/opt/spm12/spm12_mcr/spm12/spm12/tpm/TPM.nii,2'};
...
matlabbatch{2}.spm.spatial.preproc.tissue(3).tpm = {'/opt/spm12/spm12_mcr/spm12/spm12/tpm/TPM.nii,3'};
matlabbatch{2}.spm.spatial.preproc.tissue(3).ngaus = 2;
matlabbatch{2}.spm.spatial.preproc.tissue(3).native = [1 0];
matlabbatch{2}.spm.spatial.preproc.tissue(3).warped = [0 0];
matlabbatch{2}.spm.spatial.preproc.tissue(4).tpm = {'/opt/spm12/spm12_mcr/spm12/spm12/tpm/TPM.nii,4'};
matlabbatch{2}.spm.spatial.preproc.tissue(4).ngaus = 3;
matlabbatch{2}.spm.spatial.preproc.tissue(4).native = [1 0];
matlabbatch{2}.spm.spatial.preproc.tissue(4).warped = [0 0];
matlabbatch{2}.spm.spatial.preproc.tissue(5).tpm = {'/opt/spm12/spm12_mcr/spm12/spm12/tpm/TPM.nii,5'};
matlabbatch{2}.spm.spatial.preproc.tissue(5).ngaus = 4;
matlabbatch{2}.spm.spatial.preproc.tissue(5).native = [1 0];
matlabbatch{2}.spm.spatial.preproc.tissue(5).warped = [0 0];
matlabbatch{2}.spm.spatial.preproc.tissue(6).tpm = {'/opt/spm12/spm12_mcr/spm12/spm12/tpm/TPM.nii,6'};
